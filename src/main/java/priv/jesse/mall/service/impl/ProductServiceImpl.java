...
//        calendar.add(Calendar.DAY_OF_MONTH, -14);
    ...
    public List<Product> findRecommendProduct(Pageable pageable,int buyer_id){
    	System.out.println("findRecommendProduct");
    	return productDao.findRecommendProduct(pageable,buyer_id);
    }
    /**
     * 根据一级分类查找商品
     *
